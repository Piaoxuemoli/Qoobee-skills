...
from ..base import (
    ...
    enable_text_shrink, add_oval, add_title, add_footer,
)
...
def add_section_divider(prs, *,
    ...
    """Full-bleed section divider with left panel."""
...
def add_stat_hero(prs, *,
                  ...
                  page_number=None,
                  theme: Theme = DEFAULT_THEME):
    """One big number + label + optional context."""
    slide = blank_slide(prs)
    if title:
    ...
    tb = add_textbox(slide, layout.margin_left_in, body_top + 0.4,
    ...
    tb = add_textbox(slide, layout.margin_left_in,
                     body_top + 0.4 + num_h + 0.05, width, 0.50)
